...
<table class="table hovered bordered striped">
    <thead>
        ...
        <tr style="display:none;" id="cariTR" class="selected">
            ...
            <th class="text-left">
                <!-- <input placeholder="tglmulai" id="tglmulaiS" name="tglmulaiS"> -->
            </th>
            <th class="text-left">
                <!-- <input placeholder="tglakhir" id="tglakhirS" name="tglakhirS"> -->
            </th>
            <th class="text-left">
                <!-- <input placeholder="keterangan" id="keteranganS"name="keteranganS"> -->
            </th>
            <th class="text-left"></th>
        </tr>
    </thead>
