...
<table class="table hovered bordered striped">
    <thead>
        ...
        <tr style="display:none;" id="cariTR" class="selected">
            ...
            <th class="text-left"><input placeholder="pelajaran" id="pelajaranS" name="pelajaranS"></th>
            <th class="text-left"><input placeholder="singkatan" id="singkatanS" name="singkatanS"></th>
            <th class="text-left"><input placeholder="skm" id="skmS" name="skmS"></th>
