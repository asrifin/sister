...
$hasil = $koneksi_db->sql_query( "UPDATE psbcalon_useraura SET biodata='$biodata',avatar='$namagambar' WHERE UserId='$id'" );
...
$hasil = $koneksi_db->sql_query( "UPDATE psbcalon_useraura SET biodata='$biodata' WHERE UserId='$id'" );
