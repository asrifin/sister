...
$admin .= '	
	<tr>
		<td colspan="9" ></td>
		<td ><a href="./admin.php?pilih=penjualanbiaya&mod=yes" class="btn btn-success">Simpan Detail</a></td>
	</tr>';
	}else{
foreach ($_SESSION["product_id"] as $cart_itm)
        {
...
$admin .= '	
	<tr>
		<td colspan="9" ></td>
		<td ><a href="./admin.php?pilih=penjualanbiaya&mod=yes&editdetail=ok" class="btn btn-warning">Edit Detail</a></td>
	</tr>';			
