...
-- ----------------------------
INSERT INTO `pus_detail_setting` VALUES ('1', '1', 'nomorauto', '2', 'Nomor otomatis (incremental). Panjang digit maksimal 5 karakter dengan penambahan angka 0 di depan. Jika panjang digit tidak diberikan atau 0 maka panjang digit sesuai angka asli tanpa penambahan angka 0 di depan.\r\nContoh:\r\n[nomorauto.5] untuk nomor otomatis dengan panjang digit lima karakter.[nomorauto] untuk nomor otomatis dengan panjang digit sesuai angka asli.', '1', '1', '1');
...
INSERT INTO `pus_detail_setting` VALUES ('6', '2', 'lokasi', '', '', '0', '1', '1');
INSERT INTO `pus_detail_setting` VALUES ('7', '2', 'tingkat', '', '', '0', '1', '2');
INSERT INTO `pus_detail_setting` VALUES ('8', '2', 'tahun', '', '', '0', '1', '3');
INSERT INTO `pus_detail_setting` VALUES ('9', '2', 'nomorauto', '5', '', '1', '1', '4');
INSERT INTO `pus_detail_setting` VALUES ('10', '3', 'instansi', 'ELYON SCHOOL LIBRARY 9', 'nama instansi', '1', '1', '1');
